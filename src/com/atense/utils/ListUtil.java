...
public class ListUtil {
    ...
    /**
     * @see {@link ArrayUtil#getPrevious(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getPrevious(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V)ArrayUtil.getPrevious(sourceList.toArray(), value, true);
    }
